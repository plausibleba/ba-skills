/**
 * EnrichStructureView — Structure & Depth section
 * Renders the three structure enrichment cards (subactivities, ppit, cards)
 */
...
export function EnrichStructureView() {
  ...
  const sectionCards = ENRICHMENT_CARDS.filter((c) => c.category === "structure");
