...
/* ── Transformation Pane ───────────────────────────────────────────── */
/* Future home of: Painpoints, Ideas, Requirements, Acceptance Criteria,
   Epics, Initiatives. For now shows friction observations only. */
...
export function TransformationPane({
  ...
  return (
    <div className="overflow-y-auto border-t border-gray-100 bg-gray-50/40 px-3 py-2 scrollbar-thin">
